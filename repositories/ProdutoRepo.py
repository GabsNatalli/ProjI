...
#             return [Produto(*p) for p in tuplas]
#         except sqlite3.Error as e:
#             print(e)
#             return None
...
#             with criar_conexao() as conexao:
#                 cursor = conexao.cursor()
#                 cursor.execute(SQL_ALTERAR, (produto.nome, produto.descricao, produto.preco, produto.id))
#             if cursor.rowcount > 0:
#                 return produto
#         except sqlite3.Error as e:
#             print(e)
...
#     @classmethod
#     def excluir(cls, id_produto: int) -> bool or None:
#         try:
#             with criar_conexao() as conexao:
#                 cursor = conexao.cursor()
